<?php
	...
	$query = "SELECT * FROM teacher WHERE status=0 AND type=0 ";
...
<html lang="en" dir="ltr">
	...
	<body>
		...
		<center>
		<form action='../../returning_apis/ChangeUserActiveStatus.php' method=POST><br><br>
			<h1>Activate SubAdmin Account</h1>
			<table>
			<tr><br>
				<th>Check</th>
				<th>Name</th>
