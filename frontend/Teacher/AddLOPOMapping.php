  ...
  <body>
    ...
    <center>
      <form action='../../returning_apis/AddCOPOMapping.php' method=POST>
        ...
        <h1>Attainment of Lab Outcome</h1>
        ...
        <table id="customers">
          ...
          <?php
            ...
            while($row2 = $result2-> fetch_array()) {
              array_push($lo_list, $row2[1]);
            }

            for ($k=0; $k<count($lo_list); $k++) {
              echo "<tr>";
                echo "<td>";
                  echo $lo_list[$k];
                echo "</td>";
                echo "<td>";
                  echo "<input type=text name='$lo_list[$k]_lo_statement' placeholder='Enter Here' />";
                echo "</td>";
                echo "<td>";
                  echo "<input type=text size=3 name='$lo_list[$k]_hours' placeholder='hours' />";
                echo "</td>";
                  for ($i=0; $i<$no_pos; $i++) {
                    echo "<td>";
                      echo "<select name='$lo_list[$k]_pos[]'>";
