...
<body>
  ...
  <center>
    <div class="container box">
      ...
      <h2 align="center">Select Lab Exit Excel file which you want to import</h2><br>
      <form action='../../returning_apis/ImportLabExitData.php' method='POST' enctype='multipart/form-data'>
