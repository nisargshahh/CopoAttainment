...
<html lang="en">
    ...
    <div class="container box">
      ...
      <h2 align="center">Select Subject for CO Attainment Level</h2>
      <form action='./ViewIndividualCOAttainment.php' method=POST enctype=multipart/form-data id='viewCOAttainmentLevel'>
