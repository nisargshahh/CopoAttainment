...
<html>
  ...
  <body><center>
    ...
    <form class="insert-form" id="insert_form" method="POST" action="../../returning_apis/SetOralMapping.php">
      <img src="../../assets/somaiya100.png" class="logo" style = "position:absolute; left:20px; top:60px; width:100px; height:100px;"><br>
      <h1 class="text-center">Select Oral Target Value</h1>
