...
<html lang="en">
        ...
        <center>
          <div class=box>
            <div style=border:solid 5px rgb(0, 0, 0); padding:10px; margin-left: auto;margin-right: auto;>
              <form action='./ViewCourseExitAttainment.php' method=POST id='viewCourseExitAttainment'><BR>
                <h2>Select Subject</h2><br>
                <select name='batch_id' id='batch_id'></BR>
                  <?php
                    $query = "SELECT * FROM batch WHERE batch_id IN (SELECT batch_id FROM course_exit_attainment) AND created_by=$user_id";
  ...
  <script type='text/javascript'>
    $(document).ready(function(){
      $('#viewCourseExitAttainment').submit(function(e){
