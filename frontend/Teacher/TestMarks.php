  ...
  <body>
    <?php include('../../assets/header.html') ?><center>
      <div class="container box">
        ...
        <h2 align="center">Select Excel file which you want to import</h2>
        <?php

          echo "<form action='../../returning_apis/ImportTestData.php' method=POST enctype=multipart/form-data>";
          ...
          $query = "SELECT * FROM batch WHERE batch_id IN (SELECT batch_id FROM co_target_value) AND created_by=$user_id";
