...
<html lang="en">
  ...
  <head>
    <title>SAT Skill Based Attainment</title>
  ...
  <body>
    ...
    <center><br>
      ...
      <h1>SAT Attainment (For Skill Based Learning)</h1>
        ...
        <center>
          <div class=box>
            <div style=border:solid 5px rgb(0, 0, 0); padding:10px; margin-left: auto;margin-right: auto;>
              <form action='./ViewSATSkillBasedAttainment.php' method=POST id='viewSATSkillBasedAttainment'><BR>
                <h2>Select Subject</h2><br>
                <select name='batch_id' id='batch_id'></BR>
                  <?php
                    $query = "SELECT * FROM batch WHERE batch_id IN (SELECT batch_id FROM sat_mapping WHERE type=4) AND created_by=$user_id";
  ...
  <script type='text/javascript'>
    $(document).ready(function(){
      $('#viewSATSkillBasedAttainment').submit(function(e){
