...
--
-- Host: localhost
-- Generation Time: Jul 21, 2022 at 06:34 AM
...
(1, '2022-2023', '2022-2023', 1, '2022-07-21 06:28:48', 1);
...
INSERT INTO `course` (`course_id`, `course_name`, `course_code`, `semester`, `created`) VALUES
(1, 'BDA', 'KJS2022', 7, '2022-07-21 06:23:10'),
(2, 'BLC', 'BLC2022', 7, '2022-07-21 06:26:15');
...
INSERT INTO `teacher` (`teacher_id`, `teacher_name`, `teacher_email`, `dept_id`, `password`, `created`, `type`) VALUES
(1, 'Prince Karania', 'princekarania@somaiya.edu', 1, 'prince@123', '2022-07-21 06:15:31', 0),
(2, 'Kashyap Kotak', 'kotakkashyap03@gmail.com', 1, 'kashyap@123', '2022-07-21 06:16:29', 0);
...
--
ALTER TABLE `batch`
  ADD CONSTRAINT `batch_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `teacher` (`teacher_id`),
