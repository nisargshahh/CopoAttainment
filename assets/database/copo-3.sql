...
(2, 'Kashyap Kotak', 'kotakkashyap03@gmail.com', 1, 'kashyap@123', '2022-07-21 06:16:29', 1);
...
ALTER TABLE `co`
  ...
  ADD CONSTRAINT `co_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `teacher` (`teacher_id`);
...
ALTER TABLE `student`
  ...
  ADD CONSTRAINT `student_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `teacher` (`teacher_id`);
