...
<div class="navbar">
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        ...
        <div class="container">
        <form class="insert-form" id="insert_form" method="POST" action="satclosure.php">
...
$mlo5 = $_POST['mlo5'];
$mlo6 = $_POST['mlo6'];
$sql = "insert into sat_closure(uname,glo1,glo2,glo3,glo4,glo5,glo6,aclo1,aclo2,aclo3,aclo4,aclo5,aclo6,mlo1,mlo2,mlo3,mlo4,mlo5,mlo6,batch) VALUES('".$_SESSION["uname"]."','$glo1','$glo2','$glo3','$glo4','$glo5','$glo6','$aclo1','$aclo2','$aclo3','$aclo4','$aclo5','$aclo6','$mlo1','$mlo2','$mlo3','$mlo4','$mlo5','$mlo6','$u')";
$result=mysqli_query($conn,$sql);
...
if ($result){
  ...
  echo "<div class=fixed2>Error entering data</div>";
    ...
    ?>
      ...
      <tr>
    <td>Gap</td>
    <td><input type=text name='glo1'></td>
    <td><input type=text name='glo2'></td>
    <td><input type=text name='glo3'></td>
    <td><input type=text name='glo4'></td>
    <td><input type=text name='glo5'></td>
    <td><input type=text name='glo6'></td>
    </tr>
<tr>
    <td>Action proposed to bridge the gap</td>
    <td><input type=text name='aclo1'></td>
    <td><input type=text name='aclo2'></td>
    <td><input type=text name='aclo3'></td>
    <td><input type=text name='aclo4'></td>
    <td><input type=text name='aclo5'></td>
    <td><input type=text name='aclo6'></td>
    </tr>
    ...
    <tr>
        ...
        <td><input type=text name='mlo1'></td>
        <td><input type=text name='mlo2'></td>
        <td><input type=text name='mlo3'></td>
        <td><input type=text name='mlo4'></td>
        <td><input type=text name='mlo5'></td>
        <td><input type=text name='mlo6'></td>
    </tr>
    ...
    <center>
        ...
        <a href="satclosure1.php" class="link-btn">Previous</a>
        <a href="final_sat.php" class="link-btn">Next</a>
</center>
<br>
        </div>
</div>
