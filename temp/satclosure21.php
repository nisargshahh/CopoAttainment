...
<div class="navbar">
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        ...
        <div class="container">
        <form class="insert-form" id="insert_form" method="POST" action="satclosure21.php">
...
$sql="select tvout1p from tvsle2 where uname='".$_SESSION["uname"]."' and batch='$u'";
#echo $sql;
$result=mysqli_query($conn,$sql);

while($row=mysqli_fetch_assoc($result))
{
    echo "<tr><td>Decided Target</td><td>".$row['tvout1p']."</td>";
}


$sql="select tvout2p from tvsle2 where uname='".$_SESSION["uname"]."' and batch='$u'";
#echo $sql;
$result=mysqli_query($conn,$sql);

while($row=mysqli_fetch_assoc($result))
{
    echo "<td>".$row['tvout2p']."</td>";
}


$sql="select tvout3p from tvsle2 where uname='".$_SESSION["uname"]."' and batch='$u'";
#echo $sql;
$result=mysqli_query($conn,$sql);

while($row=mysqli_fetch_assoc($result))
{
    echo "<td>".$row['tvout3p']."</td>";
}

$sql="select tvout4p from tvsle2 where uname='".$_SESSION["uname"]."' and batch='$u'";
#echo $sql;
$result=mysqli_query($conn,$sql);

while($row=mysqli_fetch_assoc($result))
{
    echo "<td>".$row['tvout4p']."</td>";
}

$sql="select tvout5p from tvsle2 where uname='".$_SESSION["uname"]."' and batch='$u'";
#echo $sql;
$result=mysqli_query($conn,$sql);

while($row=mysqli_fetch_assoc($result))
{
    echo "<td>".$row['tvout5p']."</td>";
}


$sql="select tvout6p from tvsle2 where uname='".$_SESSION["uname"]."' and batch='$u'";
#echo $sql;
$result=mysqli_query($conn,$sql);

while($row=mysqli_fetch_assoc($result))
{
    echo "<td>".$row['tvout6p']."</td>";
}
        

$sql="select per1 from satotal2_perc where uname='".$_SESSION["uname"]."' and batch='$u'";
#echo $sql;
$result=mysqli_query($conn,$sql);
...
$sql="select per2 from satotal2_perc where uname='".$_SESSION["uname"]."' and batch='$u'";
#echo $sql;
$result=mysqli_query($conn,$sql);
...
$sql="select per3 from satotal2_perc where uname='".$_SESSION["uname"]."' and batch='$u'";
#echo $sql;
$result=mysqli_query($conn,$sql);
...
$sql="select per4 from satotal2_perc where uname='".$_SESSION["uname"]."' and batch='$u'";
#echo $sql;
$result=mysqli_query($conn,$sql);
...
$sql="select per5 from satotal2_perc where uname='".$_SESSION["uname"]."' and batch='$u'";
#echo $sql;
$result=mysqli_query($conn,$sql);
...
$sql="select per6 from satotal2_perc where uname='".$_SESSION["uname"]."' and batch='$u'";
#echo $sql;
$result=mysqli_query($conn,$sql);
...
while($row=mysqli_fetch_assoc($result))
{
    ...
    <center>
        ...
        <a href="satclosure2.php" class="link-btn">Next</a>
</center>
<br>
        </div>
</form>
...
$result=mysqli_query($conn,$sql);
echo "<center>   <div class=box><div style=border:solid 5px rgb(0, 0, 0); padding:10px; margin-left: auto;margin-right: auto;><form action='satclosure21.php' method=POST><BR><h2>Select Batch</h2><select name=batch></BR>";
