<?php
	...
	if (isset($_SESSION['uname'])) {
		...
		$insert_query = "INSERT INTO orals_attainment (batch_id, attainment_level, percentage) VALUES ($batch_id, $attainment, $percentage_upper_count)";
		if($conn-> query($insert_query)) {
			echo "<script>
				alert('Data Inserted Successfully!!');
				window.location.href='../frontend/Teacher/OralsAttainment.php';
				</script>";
			die();
		} else {
			echo "<script>
